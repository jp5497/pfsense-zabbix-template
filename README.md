...
```bash
curl --create-dirs -o /root/scripts/pfsense_zbx.php https://raw.githubusercontent.com/jp5497/pfsense-zabbix-template/master/pfsense_zbx.php
```
...
Then import yaml/xml templates in Zabbix and add your pfSense hosts.
